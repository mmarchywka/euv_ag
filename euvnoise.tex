...
\newcommand{\mjmstatuswarn}{{\bf{  }} \mjmreleasewarning }
...
%\newcommand{\mjmstatuswarn}{  }
		\newcommand{\mjmstatuswarn}{{\bf{This document is a non-public DRAFT and contents may be speculative or undocumented or simple musings with lots of errors  and should be read as such.  }}   }
\fi
...
\expandableinput{mjm_squaring.tex}
...
\input{mjm_modelling_options.tex}
